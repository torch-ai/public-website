			...
			<section className={`${Static['service']} post`}>
				<InView as='div' onChange={(inView, entry) => setNavColor(inView ? 'black' : 'white')}>
					<div className={`${Static['content']}`}>
						...
						<p>Last updated: January 09, 2022</p>
						...
						<ul>
							...
							<li>
								<p>
									...
									Torch Research, LLC., 5250 W 116TH Pl, Ste 200, Leawood, KS 66211.
								</p>
							</li>
							<li>
								<p>
							...
							<li>
								<p>
									...
									<a href='https://torch.ai' rel='external nofollow noopener' target='_blank'>
										https://torch.ai
									</a>
								</p>
							</li>
					...
					<div className={`${Static['content']}`}>
						...
						<p>
							...
							of an obligation under these Terms shall not effect a party's ability to exercise such
