			...
			<section className={`${Static['service']}`}>
				<InView as='div' onChange={(inView, entry) => setNavColor(inView ? 'black' : 'white')}>
					...
					<div className={`${Static['content']}`}>
						...
						<p>
							TORCH.AI NaaS Terms of Service can be TORCH.AI owns the NEXUS™ software suite, through
							which it provides certain software solutions delivered either by on-premises or
							software-as-a-service (through its NEXUS™-as-a-Service offering) delivery models. The
							Terms of Service for NEXUS™-as-a-Service are located{' '}
							<a href='../terms/62165287b0c6e1dd637c8e75_NaaS-Terms-8.27.2021.pdf' target='_blank'>
								{' '}
								here{' '}
							</a>
							.
					...
					<div className={`${Static['content']}`}>
						...
						<p>
							TORCH.AI owns the NEXUS™ software suite, through which it provides certain software
							solutions delivered either by on-premises or software-as-a-service (through its
							NEXUS™-as-a-Service offering) delivery models. All use of NEXUS™ by End Users is
							conditioned upon agreement with the EULA which is located{' '}
							<a href='../terms/6128f1444f09249ec2ac66d8_EULA.pdf' target='_blank'>
								here
							</a>
							.
						</p>
